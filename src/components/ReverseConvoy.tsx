export default function ReverseConvoy() {
  return (
    ...
    >
      ...
      {/* Reverse convoy - traveling left */}
      <div
        className="absolute bottom-5 flex items-end gap-10"
        style={{
          animation: "convoy-drive-reverse 22s linear infinite",
          willChange: "transform",
          transform: "scaleX(-1)",
        }}
      >
        {/* Lead: Skoolie (converted school bus) */}
        <svg width="150" height="62" viewBox="0 0 300 125" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Roof rack with solar + kayak */}
        ...
        {/* Van 2 - Smaller Transit */}
        <svg width="90" height="48" viewBox="0 0 180 96" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Main body */}
        ...
        {/* Motorcycle - loaded for touring */}
        <svg width="65" height="42" viewBox="0 0 130 84" fill="none" xmlns="http://www.w3.org/2000/svg">
          {/* Rear rack/luggage */}
