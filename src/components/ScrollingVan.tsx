...
export default function ScrollingVan() {
  return (
    ...
    >
      ...
      {/* Vehicle convoy - CSS animation, no JS scroll */}
      <div
        className="absolute bottom-5 flex items-end gap-8"
        style={{
          animation: "convoy-drive 18s linear infinite",
      ...
      >
        ...
        <svg width="140" height="60" viewBox="0 0 280 120" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="60" y="3" width="30" height="8" rx="2" fill="#7C3AED" fillOpacity="0.6" /> {/* Kayak */}
          <rect x="130" y="2" width="50" height="9" rx="2" fill="#1CA288" fillOpacity="0.5" stroke="#1CA288" strokeWidth="1" /> {/* Solar */}
          {/* Main body - long bus shape */}
          ...
          {/* Windows - multiple small ones (bus style) */}
          ...
          {/* Covered rear windows (converted) */}
        ...
        {/* Second van - VW-style / smaller camper */}
        <svg width="90" height="50" viewBox="0 0 180 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Windshield - large, classic van style */}
        ...
        {/* Third van - Transit / high-roof style */}
